...
let diffInMs = new Date(atualDay) - new Date (dataInput) 
let diffInDays = Math.trunc(diffInMs / (1000*60*60*24))
...
let textContent = `Você atingirá o seu objetivo, em ${diffInDays}, seu objetivo custará xxxx, se for persistente seu objetivo te custará xxxx ao mês.`
